...
const MOCK_STAGING: StagingRecord[] = [
    ...
    },
    {
        ...
        canonicalPayload: {
            entityType: "PRODUCT",
            canonicalName: "INDUSTRIAL PUMP XR-900",
            sku: "PUMP-XR-900-IND",
            categoryCode: "MACH",
            uom: "UNIT",
            pricing: {
        ...
        validationRules: [
            { rule: "Name Not Null", result: "PASS" },
            { rule: "SKU Format Valid", result: "PASS" },
            { rule: "Price > 0", result: "PASS" },
            { rule: "Category Mapped", result: "PASS" },
            { rule: "Duplicate Check", result: "PASS" },
        ],
    },
    {
        ...
        canonicalPayload: {
            entityType: "ACCOUNT",
            canonicalName: "CORPORATE MAIN AC",
            accountNumber: "ACC-9910-CORP",
            currency: "INR",
            accountType: "CURRENT",
            bankDetails: {
        ...
        validationRules: [
            { rule: "Account Name Not Null", result: "PASS" },
            { rule: "Account Number Format", result: "PASS" },
            { rule: "Currency Code Valid", result: "PASS" },
            { rule: "IFSC Code Valid", result: "PASS" },
        ],
    },
    {
        id: "STG-20087",
        ...
        canonicalPayload: {
            entityType: "SUPPLIER",
            canonicalName: "MEHTA PRECISION PARTS",
            taxId: "GSTIN29AA2150P1ZQ",
            primaryEmail: "supply@mehta.co.in",
            paymentTerms: "NET30",
            currency: "INR",
        },
        validationRules: [
            { rule: "Name Not Null", result: "PASS" },
            { rule: "GSTIN Format Valid", result: "PASS" },
            { rule: "Email Format Valid", result: "PASS" },
            { rule: "Payment Terms Valid", result: "PENDING" },
        ],
    },
    {
        id: "STG-20086",
        ...
        canonicalPayload: {},
        validationRules: [
            { rule: "Name Not Null", result: "FAIL" },
            { rule: "Email Format Valid", result: "PASS" },
            { rule: "Phone Normalised", result: "PASS" },
            { rule: "Address Completeness", result: "FAIL" },
            { rule: "Duplicate Check", result: "FAIL" },
        ],
    },
    {
        id: "STG-20085",
